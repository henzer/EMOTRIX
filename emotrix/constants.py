...
HEADSET_MAX_VALUE = 4095

HEADSET_BUFFER_SIZE = 100
...
HEADSET_BAD_SIGNAL_MAX_AMPLITUDE = 58
HEADSET_GOOD_SIGNAL_MAX_AMPLITUDE = 4096
...
HEADSET_NO_SIGNAL_MIN_STD = 2
HEADSET_NO_SIGNAL_MAX_STD = 4

HEADSET_BAD_SIGNAL_MIN_STD = 50
HEADSET_BAD_SIGNAL_MAX_STD = 300

HEADSET_GOOD_SIGNAL_MIN_STD = 900
HEADSET_GOOD_SIGNAL_MAX_STD = 1500
